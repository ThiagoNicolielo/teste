...
-- muros do golf club:
local grpMuros = display.newGroup()
local muroD = display.newRect( grpMuros, 0, 0, 5, _H)
muroD:setFillColor(255)
local muroE = display.newRect( grpMuros, _W - 5, 0, _W, _H)
muroE:setFillColor(255)
local muroS = display.newRect( grpMuros, 0, 0, _W, 5)
muroS:setFillColor(255)
local muroI = display.newRect( grpMuros, 0, _H - 5, _W, _H)
muroI:setFillColor(255)
-- add physics para o muro
physics.addBody( muroD, "static" )
physics.addBody( muroE, "static" )
physics.addBody( muroS, "static" )
physics.addBody( muroI, "static" )
